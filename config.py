...
NUM_VARIATIONS_TO_GENERATE = int(os.environ.get("NUM_VARIATIONS_TO_GENERATE", 5)) # Added back
...
try:
    ...
    VARIATION_SOURCE_MAX_RATING = 7.4; NUM_VARIATIONS_TO_GENERATE = 5 # Added back default
