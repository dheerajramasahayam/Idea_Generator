...
try:
    ...
    MAX_RUNS = int(os.environ.get("MAX_RUNS", 1)) # Limit to 1 run for testing fact extraction
    ...
    MAX_RUNS = 1; WAIT_BETWEEN_BATCHES = 10; EXPLORE_RATIO = 0.2 # Limit to 1 run for testing fact extraction
